...
type abciAPIserver struct {
	node   Node
	logger server.Logger
	lock   sync.RWMutex
}

func (e *abciAPIserver) rollback(head *Block, safeHash, finalizedHash eetypes.Hash) error {
	e.logger.Debug("abciAPIserver.rollback", "head", head.Height(), "safe", safeHash, "finalized", finalizedHash)
...
func (e *abciAPIserver) ForkchoiceUpdatedV1(
...
func (e *abciAPIserver) ForkchoiceUpdatedV2(
	fcs eth.ForkchoiceState,
	pa eth.PayloadAttributes,
) (*eth.ForkchoiceUpdatedResult, error) {
...
func (e *abciAPIserver) ForkchoiceUpdatedV3(
	fcs eth.ForkchoiceState,
	pa eth.PayloadAttributes,
) (*eth.ForkchoiceUpdatedResult, error) {
...
func (e *abciAPIserver) GetPayloadV1(payloadID eetypes.PayloadID) (*eth.ExecutionPayloadEnvelope, error) {
	e.logger.Debug("GetPayloadV1", "payload_id", payloadID)
	return e.GetPayloadV3(payloadID)
}

func (e *abciAPIserver) GetPayloadV2(payloadID eetypes.PayloadID) (*eth.ExecutionPayloadEnvelope, error) {
	e.logger.Debug("GetPayloadV2", "payload_id", payloadID)
	return e.GetPayloadV3(payloadID)
}

// OpNode sequencer calls this API to seal a new block
func (e *abciAPIserver) GetPayloadV3(payloadID eetypes.PayloadID) (*eth.ExecutionPayloadEnvelope, error) {
	e.lock.RLock()
...
func (e *abciAPIserver) NewPayloadV1(payload eth.ExecutionPayload) (*eth.PayloadStatusV1, error) {
...
func (e *abciAPIserver) NewPayloadV2(payload eth.ExecutionPayload) (*eth.PayloadStatusV1, error) {
	e.logger.Debug("trying: NewPayloadV2", "payload.ID", payload.ID(), "blockHash", payload.BlockHash.Hex(), "height", e.node.LastBlockHeight()+1)
	return e.NewPayloadV3(payload)
}

func (e *abciAPIserver) NewPayloadV3(payload eth.ExecutionPayload) (*eth.PayloadStatusV1, error) {
