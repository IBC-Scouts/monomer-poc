...
func GetExecutionEngineAPIs(node Node, gethClient client.RPC, enabledApis server.ApiEnabledMask, logger server.Logger) []rpc.API {

	abciEngine := abciAPIserver{node: node, logger: logger.With("module", "abci_engine")}
	ethApi := newEthAPI(gethClient, logger.With("module", "eth"))

	apis := []rpc.API{
		{
			Namespace: "engine",
			Service:   &engineServer{gethClient: gethClient, abciEngine: abciEngine, logger: logger.With("module", "engine")},
		}, {
			Namespace: "eth",
			Service:   ethApi,
		},
...
type engineServer struct {
	...
	abciEngine abciAPIserver

	logger server.Logger
}

// newExecutionEngineAPI returns a new execEngineAPI.
func newEngineAPI(gethClient client.RPC, abciEngine abciAPIserver, logger server.Logger) *engineServer {
	return &engineServer{gethClient, abciEngine, logger}
}
...
func (e *engineServer) ForkchoiceUpdatedV1(
	...
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_forkchoiceUpdatedV1", fcs, pa)
...
func (e *engineServer) ForkchoiceUpdatedV2(
	...
	var result eth.ForkchoiceUpdatedResult
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_forkchoiceUpdatedV2", fcs, pa)
...
func (e *engineServer) ForkchoiceUpdatedV3(
	...
	var result eth.ForkchoiceUpdatedResult
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_forkchoiceUpdatedV3", fcs, pa)
...
func (e *engineServer) GetPayloadV1(payloadID eth.PayloadID) (*eth.ExecutionPayload, error) {
	...
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_getPayloadV1", payloadID)
...
func (e *engineServer) GetPayloadV2(payloadID eth.PayloadID) (*eth.ExecutionPayloadEnvelope, error) {
	...
	var result eth.ExecutionPayloadEnvelope
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_getPayloadV2", payloadID)
...
func (e *engineServer) GetPayloadV3(payloadID eth.PayloadID) (*eth.ExecutionPayloadEnvelope, error) {
	...
	var result eth.ExecutionPayloadEnvelope
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_getPayloadV3", payloadID)
...
func (e *engineServer) NewPayloadV1(payload *eth.ExecutionPayload) (*eth.PayloadStatusV1, error) {
	...
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_newPayloadV1", payload)
...
func (e *engineServer) NewPayloadV2(payload *eth.ExecutionPayload) (*eth.PayloadStatusV1, error) {
	...
	var result eth.PayloadStatusV1
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_newPayloadV2", payload)
...
func (e *engineServer) NewPayloadV3(payload *eth.ExecutionPayload) (*eth.PayloadStatusV1, error) {
	...
	var result eth.PayloadStatusV1
	err := e.gethClient.CallContext(context.TODO(), &result, "engine_newPayloadV3", payload)
...
func newEthAPI(engine client.RPC, logger server.Logger) *ethServer {
